...
public final class SkillLevelGate {
    ...
    public record MissingReq(String skillId, int required, Identifier advId) {
        ...
        static MissingReq adv(Identifier id) {
    ...
    private static Component getAdvancementDescription(ServerPlayer player, Identifier id) {
    ...
    private static Component prettyAdvName(Identifier id) {
            ...
            if (!reqs.isEmpty()) {
                for (String raw : reqs.split(",")) {
                    ...
                    if (keyRaw.equalsIgnoreCase("ADV")) {
                        Identifier id = Identifier.tryParse(valRaw);
                        if (id != null) {
                            advReqs.add(id);
                        }
                        continue;
